...
__>CLASSE: PAWN.H
	...
	Realizza la figura del Pedone { int Type = 3 } negli scacchi, esso si può muovere solo di 1 posizione in avanti (2 se non si è mai mosso durante la partita) e può "mangiare" le pedine che si trovano nelle posizioni
	N-E e N-W a distanza di 1 dalla pedina

__>VARIABILI DI CLASSE
	- bool moved:		Variabile che ci dice se il pedone si è mai mosso durante la partita o deve ancora farlo
...
__>FUNZIONI
	...
	- has_moved:		Ci dice se la pedina si è mai mossa [true --> mossa]
															[false --> mai mossa]
