...
__>CLASSE: ROOK.H
	...
	La torre si muove nelle direzioni "cardinali" alla sua posizione, cioè in linea retta a N, W, E e S {*vedi Piece.h per capire le lettere}

__>VARIABILI DI CLASSE
	- bool moved:		Variabile che ci dice se la torre si è mai mossa durante la partita o deve ancora 
